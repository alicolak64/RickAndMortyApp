...
class FemaleCharacterTableViewCell: UITableViewCell {
    static let identifier = "FemaleCharacterTableViewCell"
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        NSLayoutConstraint.activate([
            ...
            genderImageView.trailingAnchor.constraint(equalTo: nameLabel.leadingAnchor, constant: -8),
